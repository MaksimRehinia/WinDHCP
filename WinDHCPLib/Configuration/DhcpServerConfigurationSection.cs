...
namespace WinDHCP.Library.Configuration
{
    public class DhcpServerConfigurationSection : ConfigurationSection
    {
        ...
        {
            get { return (int)this["networkInterface"]; }
        }
        ...
        protected override ConfigurationPropertyCollection Properties
        {
            get
            {
                if (this.m_Properties == null)
                {
                    ...
                    this.m_Properties.Add(new ConfigurationProperty("gateway", typeof(string), "192.168.100.1", ConfigurationPropertyOptions.IsRequired));
